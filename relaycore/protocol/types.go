...
const CurrentProtocolVersion = "1.3"
...
// local literals.
const CurrentProtocolMinor = 3

type ServiceErrorCode string

const (
	ServiceErrorDeviceCredentialInvalid ServiceErrorCode = "device_credential_invalid"
	ServiceErrorPhoneCredentialInvalid  ServiceErrorCode = "phone_credential_invalid"
	ServiceErrorAccessSuspended         ServiceErrorCode = "access_suspended"
	ServiceErrorRegistrationDisabled    ServiceErrorCode = "registration_disabled"
	ServiceErrorDeviceCapacityExceeded  ServiceErrorCode = "device_capacity_exceeded"
	ServiceErrorDeviceIdentityConflict  ServiceErrorCode = "device_identity_conflict"
	ServiceErrorDeviceAlreadyConnected  ServiceErrorCode = "device_already_connected"
	ServiceErrorProtocolUpgradeRequired ServiceErrorCode = "protocol_upgrade_required"
	ServiceErrorRegistrationRateLimited ServiceErrorCode = "registration_rate_limited"
	ServiceErrorServiceProvisioning     ServiceErrorCode = "service_provisioning"
	ServiceErrorRouteUnavailable        ServiceErrorCode = "route_unavailable"
	ServiceErrorRegionUnavailable       ServiceErrorCode = "region_unavailable"
)
...
const (
	...
	ConnectionProvisioning ConnectionState = "provisioning"
)
...
// current major (currently 3 for protocol 1.3).
